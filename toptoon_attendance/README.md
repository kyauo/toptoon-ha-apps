...
- `Zygote cannot be disabled if sandbox is enabled` 때문에 remote debugging port가 열리지 않는 시작 실패를 수정했습니다.
- v0.5.33의 V8 heap 192MB 조정은 유지했습니다.
- 버전 표기를 config, DOCS, README, CHANGELOG에서 0.5.34로 통일했습니다.
